...
### r306 · 2026-08-16 · ROUND IN PROGRESS (provisional heartbeat)
- LIGHT round (r305 had the journey). Fresh container (repo pre-cloned at
  /home/user/bgp-wip-app; pg_hba trust per r205; restore + ALTER owners +
  ...
  Two-bot round 306 running now — triage to follow. No deferred bugs
  carried in from r305.

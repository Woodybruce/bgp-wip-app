...
### r298 · 2026-08-15 · ROUND IN PROGRESS (provisional)
- LIGHT round (r297 had the journey). Fresh container (repo pre-cloned at
  ...
  cold-build flake). Two-bot round 298 running (first live run of r297's
  client-property-units-scoped scenario) — triage next.

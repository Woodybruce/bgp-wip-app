...
psql -U bgp -h localhost bgp -tA -c "
  DELETE FROM crm_deals    WHERE name LIKE 'QA-R%' OR name LIKE '%PROBE%' OR name LIKE 'QA-REVIEW%' OR name LIKE 'QA-COMM%' OR name LIKE 'QA-FWD%' OR name LIKE 'R580%' OR name LIKE 'QA-ACT%' OR name LIKE 'R581%' OR name LIKE 'QA-LRN%' OR name LIKE 'R582%';

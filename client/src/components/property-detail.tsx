    ...
    <div className="h-[calc(100vh-48px)] flex flex-col" data-testid={`property-detail-${id}`}>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
        ...
        {/* One layout at every width: the old 2xl mode doubled the aside to
            ...
            aside always. */}
        <div className={`p-4 sm:p-6 grid grid-cols-1 ${simpleLayout ? "max-w-7xl mx-auto" : "lg:grid-cols-[minmax(0,1fr)_340px]"} gap-4 lg:gap-6 items-start`} data-property-view={simpleLayout ? propertyView : "full"}>
          <div className="min-w-0 space-y-3">
            ...
            <div className={`grid grid-cols-1 ${simpleLayout ? "lg:grid-cols-2" : "xl:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)]"} gap-3`}>

  ...
  return (
    <div>
      <section className="relative">
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="mx-auto max-w-6xl px-4 pb-10 w-full">
            <p className="max-w-md text-xl md:text-2xl leading-snug bg-bgp-cream/90 p-4 -ml-4 font-display text-bgp-wine">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        <h1 className="display text-2xl md:text-3xl mb-8">A–Z contact details</h1>
